...
//         </div>
//         <div className="text-center">
//           <h1 className="text-4xl font-bold">Discover Premium Accessories</h1>
//           <p className="text-lg mt-2">High-quality gear for every setup.</p>
//           <a
//             href="/shop"
//             className="mt-4 inline-block px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition"
//           >
//             Shop Now
//           </a>
//         </div>
...
//                 <Image
//                   src={`/images/product-${product}.jpg`} // Replace with actual product images
//                   alt="Product Name"
//                   width={300}
//                   height={200}
...
//           <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
//             {["Keyboards", "Monitors", "Laptops", "Accessories"].map((category, index) => (
//               <a key={index} href={`/shop?category=${category.toLowerCase()}`} className="block bg-gray-200 rounded-lg p-6 text-center">
//                 <h3 className="text-xl font-semibold">{category}</h3>
//               </a>
//             ))}
//           </div>
...
//       {/* Promotional Banner */}
//       <section className="relative w-full h-[300px] flex items-center justify-center bg-gray-900 text-white">
//         <div className="absolute inset-0 -z-10">
//           <Image
//             src="/images/sale-banner.jpg" // Replace with a real promotional banner
//             alt="Sale Banner"
//             layout="fill"
//             objectFit="cover"
//             quality={100}
...
//         </div>
//         <div className="text-center">
//           <h2 className="text-3xl font-bold">Limited Time Offer - Up to 30% Off</h2>
//           <a
//             href="/shop"
//             className="mt-4 inline-block px-6 py-3 bg-red-600 text-white font-medium rounded-md hover:bg-red-700 transition"
//           >
//             Shop Deals
//           </a>
//         </div>
...
//         <p>&copy; 2025 Compdock. All Rights Reserved.</p>
//       </footer>
//     </main>
//   );
// }
